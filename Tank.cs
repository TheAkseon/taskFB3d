...
public class Tank : MonoBehaviour
{
    ...
    private void Shoot()
    {
        _randomBullet = Random.Range(0, _bulletTemplate.Length);
        Instantiate(_bulletTemplate[_randomBullet], _shootPoint.position, Quaternion.identity);
    }
}
